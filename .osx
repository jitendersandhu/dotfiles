...
# Run this below command to find the default OSX settings
# defaults read > a
# Change the setting
# defaults read > b
# diff a b
#
# Use plistbuddy instead to find the diff
...
# To install Package Control, http://sublime.wbond.net/Package%20Control.sublime-package needs to be placed inside of the Installed Packages/ folder.
# The next time Sublime starts, it will install the package.

cd ~/Library/Application\ Support/Sublime\ Text*/Installed\ Packages && curl -o 'Package Control.sublime-settings' http://sublime.wbond.net/Package%20Control.sublime-package ; cd -;

# To batch install other packages, Package Control.sublime-settings file needs to be placed into the Packages/User/ folder.
